...
import { CUSTOM_MAZE_STEPFORWARD, CUSTOM_MAZE_TURN, CUSTOM_MAZE_CHECKWALL } from './blocks';
import {
	CUSTOM_COMMON_IF,
...
import { BlocklyToolboxDefinition, useBlocklyWorkspace } from '../common/blockly';
